...
const components: ComponentGroup[] =
  ComponentConfig['menus']['zh']['/components'];
...
export default props => {
  ...
  const [title, setTitle] = useState('Qnet UI Mobile');
  ...
  useLayoutEffect(() => {
    ...
    setTitle(componentToTitle[component] || 'Qnet UI Mobile');
  }, [match.params]);
    ...
    <div style={{ height: window.innerHeight }} className={styles.gallery}>
      ...
      <div className={styles.body} hidden={currentDemoIndex !== null}>
        <div className={styles.guide}>
          ...
          />
          <p>下面是一些 Qnet UI Mobile 的组件 demo，可以点进去试一试</p>
          <p>
